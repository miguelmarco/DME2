...
void sha2_256_block(const unsigned char *buf, struct sha2_256_ctx *ctx) /* buf: 64 bytes */
{
...
void sha2_256_finish_ctx(struct sha2_256_ctx *ctx, unsigned char *result) /* result: 32 bytes */
{
  int i;
  ctx->buf[ctx->pending++] = 0x80;
  if (ctx->pending > 56)
  {
